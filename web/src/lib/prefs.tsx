...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    files_hint_one: 'You have one computer. The second pane is empty until you add another.',
    second_slot: 'Second computer',
    second_slot_lead: 'This is not a second copy of your Mac — it is an empty slot. Add a PC or another Mac, then drag files across.',
  ...
  ru: {
    ...
    files_hint_one: 'Подключён один компьютер. Второе окно пустое, пока не добавишь ещё один.',
    second_slot: 'Второй компьютер',
    second_slot_lead: 'Это не второй экземпляр твоего Mac — это пустой слот. Добавь ПК или ещё один Mac, тогда файлы можно будет перетаскивать сюда.',
